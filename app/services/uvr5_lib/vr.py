    ...
    def _path_audio_(self, music_file, ins_root=None, vocal_root=None, format="flac", is_hp3=False):
        ...
        if ins_root is not None:
            ...
            if format in ["wav", "flac"]:
                sf.write(
                    os.path.join(
                        ins_root,
                        "{}_{}.{}".format(name.split(".")[0], head, format),
                    ),
                    (np.array(wav_instrument) * 32768).astype("int16"),
                    self.mp.param["sr"],
                )  #
            else:
                path = os.path.join(ins_root, "{}_{}.wav".format(name.split(".")[0], head))
                sf.write(
                    path,
                    (np.array(wav_instrument) * 32768).astype("int16"),
                    self.mp.param["sr"],
        ...
        if vocal_root is not None:
            ...
            if format in ["wav", "flac"]:
                ...
                path = os.path.join(vocal_root, "{}_{}.wav".format(name.split(".")[0], head))
                sf.write(
                    path,
                    (np.array(wav_vocals) * 32768).astype("int16"),
                    self.mp.param["sr"],
        ...
        if ins_root is not None:
            ...
            if format in ["wav", "flac"]:
                sf.write(
                    os.path.join(
                        ins_root,
                        "{}_vocal.{}".format(name.split(".")[0], format),
                    ),
                    (np.array(wav_instrument) * 32768).astype("int16"),
                    self.mp.param["sr"],
                )  #
            else:
                path = os.path.join(ins_root, "{}_vocal.{}".format(name.split(".")[0], format))
                sf.write(
                    path,
                    (np.array(wav_instrument) * 32768).astype("int16"),
                    self.mp.param["sr"],
        ...
        if vocal_root is not None:
            ...
            if format in ["wav", "flac"]:
                sf.write(
                    os.path.join(
                        vocal_root,
                        "{}_instrument.{}".format(name.split(".")[0], format),
                    ),
                    (np.array(wav_vocals) * 32768).astype("int16"),
                    self.mp.param["sr"],
                )
            else:
                path = os.path.join(vocal_root, "{}_instrument.{}".format(name.split(".")[0], format))
                sf.write(
                    path,
                    (np.array(wav_vocals) * 32768).astype("int16"),
                    self.mp.param["sr"],
